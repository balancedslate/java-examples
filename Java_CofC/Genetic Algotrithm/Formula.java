...
// This class is used to create a data structure from the input which
// allows for quick access and evaluation of a formula.
// I want you to work with HashSets and ArrayLists directly, so
//    everything is public in this class as you will have to 
//    do the work of interacting with a formula yourself.
...
// Variable names are limited to a single, lowercase letter. 
// - represents negation, | represents disjunction, ^ represents conjunction
// 
// Examples:
//   input: "(a | b) ^ (b | c) ^ d"
...
//   HashSets. Thus, the order of the variables in the HashSets is not fixed. 
...
public class Formula {
  ...
  public Formula(String input){
     ...
     // the clauses which represent a disjunction of literals.
    boolean negative = false;
    HashSet<String> clause = new HashSet<String>();
    int clauseNum = 0;
    
    // Create a separate HashSet to count the number of distinct variables
